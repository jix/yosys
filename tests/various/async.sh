...
../../yosys -q -o async_a2s.v -r uut -p 'prep; async2sync -neghold; rename uut a2s' async.v
../../yosys -q -o async_ffl.v -r uut -p 'prep; clk2fflogic -neghold; rename uut ffl' async.v
