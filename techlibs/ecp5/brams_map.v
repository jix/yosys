...
DP16KD #(
	...
	.CSDECODE_A("0b000"),
	.CSDECODE_B("0b000"),
	.CLKAMUX(PORT_A_CLKPOL ? "CLKA" : "INV"),
	.CLKBMUX(PORT_B_CLKPOL ? "CLKB" : "INV"),
...
DP16KD #(
	...
	.CSDECODE_A("0b000"),
	.CSDECODE_B("0b000"),
	.CLKAMUX(PORT_W_CLKPOL ? "CLKA" : "INV"),
	.CLKBMUX(PORT_R_CLKPOL ? "CLKB" : "INV"),
	.GSR("AUTO")
) _TECHMAP_REPLACE_ (
	.CLKA(PORT_W_CLK),
